                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Add System Type</h4>
                                    </div>
                                    <div class="card-body">
                                        <?= form_open('dev/add_system'); ?>
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="first-name-column">System Type</label>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="table1">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach ($system as $us) : ?>
                                                <tr>
                                                    <td><?= $i; ?>.</td>
                                                    <td><?= $us['type']; ?></td>
                                                    <td class="text-wrap" style=" max-width: 400px;"><?= $us['nfr']; ?></td>
                                                    <td>
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#editModal<?= $us['id_system']; ?>" class="btn icon icon-left btn-secondary"><i data-feather="edit"></i> Edit</button>
                                                        <!--login form Modal -->
                                                        <div class="modal fade text-left" id="editModal<?= $us['id_system']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true" data-bs-backdrop="false">
                                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <?= form_open('dev/edit_system/' . $us['id_system'], 'id="editUserForm"') ?>
                                                        ...
                                                        <button onclick="confirmDelete(<?= $us['id_system']; ?>)" class="btn icon icon-left btn-danger"><i data-feather="delete"></i> Delete</button>
                                                    </td>
                                                </tr>
                                                <?php $i++; ?>
                                            <?php endforeach; ?>
    ...
    function confirmDelete(param1) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?= base_url('dev/delete_system/'); ?>" + param1;
            } else {
                Swal.fire({
                    title: "Cancelled",
